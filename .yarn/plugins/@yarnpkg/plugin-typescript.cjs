        ...
        var plugin = (() => {
            ...
            var I = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
                ...
                Qt = (e, t, r) => {
                    if (t && typeof t == "object" || typeof t == "function") {
                        for (let s of Gt(t)) {!ne.call(e, s) && s !== "default"
            ...
            var Ze = I(A => {
                ...
                function ce(e, t) {
                    ...
                    return Object.keys(r).forEach(n => {
                        ["timeout", "headers", "queryParameters", "data", "cacheable"].indexOf(n) === -1
                            && (s[n] = r[n]);
                    }),
                        {
                                ...
                                return p.responsesCache.get(
                                    ...
                                    () =>
                                        p.requestsCache.get(v, () =>
                                            p.requestsCache.set(v, P()).then(j =>
                                                Promise.all([p.requestsCache.delete(v), j]), j =>
                                                Promise.all([p.requestsCache.delete(v), Promise.reject(j)])).then((
                                                    [j, T],
                                                ) => T)),
            ...
            var tt = I(w => {
                ...
                var N = F(),
                        ...
                        let t = e.region || "us",
                            ...
                            s = mr.createTransporter(
                                g(u({ hosts: [{ url: `analytics.${t}.algolia.com` }] }, e), {
                                    headers: u(
                                        g(u({}, r.headers()), { "content-type": "application/json" }),
                                        e.headers,
                                    ),
                    ...
                    yr = e =>
                        (t, r) => e.transporter.write({ method: z.MethodEnum.Post, path: "2/abtests", data: t }, r),
                    gr = e =>
                        (t, r) =>
                            e.transporter.write({ method: z.MethodEnum.Delete, path: N.encode("2/abtests/%s", t) }, r),
                    fr = e =>
                        (t, r) =>
                            e.transporter.read({ method: z.MethodEnum.Get, path: N.encode("2/abtests/%s", t) }, r),
                    br = e => t => e.transporter.read({ method: z.MethodEnum.Get, path: "2/abtests" }, t),
                    Pr = e =>
                        (t, r) =>
                            e.transporter.write(
                                { method: z.MethodEnum.Post, path: N.encode("2/abtests/%s/stop", t) },
                                r,
                            );
                w.addABTest = yr;
            ...
            var at = I(G => {
                ...
                var me = F(),
                    ...
                    Ir = e =>
                        t => e.transporter.read({ method: nt.MethodEnum.Get, path: "1/strategies/personalization" }, t),
                    Ar = e =>
                        (t, r) =>
                            e.transporter.write({
            ...
            var jt = I(i => {
                    ...
                    let t = e.appId,
                        ...
                        s = q.createTransporter(
                            g(
                                ...
                                {
                                    headers: u(
                                        g(u({}, r.headers()), { "content-type": "application/x-www-form-urlencoded" }),
                                        e.headers,
                                    ),
                                    queryParameters: u(u({}, r.queryParameters()), e.queryParameters),
                                },
                ...
                var Rr = e =>
                    ...
                    $ = e =>
                        (t, r) => e.transporter.read({ method: m.MethodEnum.Get, path: l.encode("1/keys/%s", t) }, r),
                    ...
                    Nr = e =>
                        (t, r) =>
                            e.transporter.read(
                                { method: m.MethodEnum.Get, path: l.encode("1/clusters/mapping/%s", t) },
                                r,
                            ),
                    Wr = e =>
                        t => {
                    ...
                    Lr = e =>
                        (t, r) =>
                            Promise.all(t.map(s => {
                                ...
                                return L(e)(s.indexName, { methods: { searchForFacetValues: dt } })
                    ...
                    Xr = e =>
                        (t, r) => {
                            let s = Object.assign({}, r),
                                ...
                                b = (p, h) =>
                                    l.createRetryablePromise(S => $(e)(t, h).then(O => y(O) ? Promise.resolve() : S()));
                            return l.createWaitablePromise(
                                e.transporter.write({
                        ...
                        (t, r, s) => {
                            let y = s || {},
                                ...
                                d = (b = 0) => {
                                    ...
                                    return f.length === 0 ? Promise.resolve(o)
                                    : pt(e)(f.map(h => ({ action: r, body: h })), a).then(
                                        h => (o.objectIDs = o.objectIDs.concat(h.objectIDs),
                                ...
                                d = () =>
                                    ft(e)(s || "", g(u({}, a), { page: o })).then(b => {
                                        for (let [f, p] of Object.entries(b.hits)) {
                                            if (t(p)) return { object: p, position: parseInt(f, 10), page: o };
                                        }
                    ...
                    ms = e =>
                        (t, r) => {
                            let o = r || {},
                                ...
                                a = t.map(d =>
                                    u({ indexName: e.indexName, objectID: d }, s ? { attributesToRetrieve: s } : {})
                                );
                            return e.transporter.read({
                                method: m.MethodEnum.Post,
                                path: "1/indexes/*/objects",
                    ...
                    he = e =>
                        (t, r) => {
                            ...
                            if (a === k.UpdateObject) {
                                for (let d of t) {if (d.objectID === void 0) {
                                    ...
                                    y = (a.protocol === "https:" ? vt : Rt).request(d, h => {
                                        ...
                                        h.on("data", O => S += O),
                                            h.on("end", () => {
                                                clearTimeout(f),
                                                    clearTimeout(p),
                                                    n({ status: h.statusCode || 0, content: S, isTimedOut: !1 });
                                            });
                                    }),
                                    b = (h, S) =>
                                        setTimeout(() => {
                    ...
                    return c.createSearchClient(
                        g(u(u({}, s), r), {
                            methods: {
                                ...
                                initRecommendation: () =>
                                    n => Pe.createRecommendationClient(
                                        g(u(u({}, s), n), {
                                            methods: {
            ...
            var se = C(require("@yarnpkg/core")),
                ...
                Wt = async (e, t) => {
                    ...
                    try {
                        return ((a = (await n.getObject(r, { attributesToRetrieve: ["types"] })).types) == null
                            ? void 0
            ...
            var _t = e => e.scope ? `${e.scope}__${e.name}` : `${e.name}`,
                ...
                _s = async (e, t, r) => {
                    ...
                    for (let a of Oe.Manifest.allDependencies) {
                        typeof e.manifest[a].get(n.identHash) != "undefined" && e.manifest[a].delete(n.identHash);
                    }
                },
                Fs = (e, t) => {
