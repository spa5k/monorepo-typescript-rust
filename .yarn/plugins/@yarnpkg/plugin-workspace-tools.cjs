...
module.exports = {
    ...
    factory: function(require) {
        var plugin = (() => {
            ...
            var tt = (e, t, r) =>
                    t in e ? ge(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r,
                I = (e, t) => {
            ...
            var K = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
                ...
                Nr = (e, t, r) => {
                    if (t && typeof t == "object" || typeof t == "function") {
                        for (let n of $r(t)) {!et.call(e, n) && n !== "default"
            ...
            var mt = K((us, ut) => {
                ...
                function lt(e, t, r, n) {
                    ...
                    for (let h = 0; h < s.length; h++) {
                        ...
                        r.isPadded && (R = Ur(m, r, n)),
                            f.string = R + f.pattern + dt(f.count),
                            a.push(f),
                            i = m + 1,
                            o = f;
                    }
...
`,
            ...
            var Gt = K((ds, Pt) => {
                ...
                z.create = (e, t = {}) =>
                    e === "" || e.length < 3 ? [e] : t.expand !== !0 ? z.compile(e, t) : z.expand(e, t);
                Pt.exports = z;
            });
            var Re = K((gs, Ut) => {
                "use strict";
                ...
                var Qt = ye(),
                    ...
                    Un = (e, t) => {
                        ...
                        for (; m < n;) {
                            ...
                            if (
                                r.noext !== !0 && (g === Pn || g === In || g === je || g === Yt || g === Xt) === !0
                                && W() === Xe
                            ) {
                        ...
                        f > 0 && (T = h.slice(0, f), h = h.slice(f), R -= f),
                            x && _ === !0 && R > 0 ? (x = h.slice(0, R), U = h.slice(R)) : _ === !0
                                ? (x = "", U = h)
                                : x = h,
                            x && x !== "" && x !== "/" && x !== h && Vt(x.charCodeAt(x.length - 1))
                            && (x = x.slice(0, -1)),
                            r.unescape === !0
                            && (U && (U = Qt.removeBackslashes(U)), x && H === !0 && (x = Qt.removeBackslashes(x)));
                        let u = {
                            prefix: T,
                            input: e,
                            start: f,
                        ...
                        if (
                            r.tokens === !0 && (u.maxDepth = 0, Vt(g) || i.push(w), u.tokens = i),
                    ...
                    nr = (e, t) => {
                        ...
                        for (; !$();) {
                                    ...
                                    if (d.includes("[") && (u.posix = !0, d.includes(":"))) {
                                        ...
                                        if (q) {
                                            u.value = M + q,
                                                l.backtrack = !0,
                                                Y(),
                                                !a.output && i.indexOf(u) === 1 && (a.output = _);
                                            continue;
                                        }
                                    }
                                }
                            ...
                            if (c === ",") {
                                ...
                                S && U[U.length - 1] === "braces" && (S.comma = !0, d = "|"),
                                    C({ type: "comma", value: c, output: d });
                                continue;
                            }
                            if (c === "/") {
                            ...
                            if (c === "?") {
                                ...
                                if (u && u.type === "paren") {
                                    ...
                                    (u.value === "(" && !/[!=<:]/.test(S) || S === "<" && !/<([!=]|\w+>)/.test(re()))
                                    && (M = `\\${c}`), C({ type: "text", value: c, output: M });
                                    continue;
                                }
                            ...
                            if (c === "+") {
                                ...
                                if (
                                    u && (u.type === "bracket" || u.type === "paren" || u.type === "brace")
                                    || l.parens > 0
                                ) {
                                    C({ type: "plus", value: c });
                                    continue;
                            ...
                            if (r.bash === !0) {
                                O.output = ".*?",
                                    (u.type === "bos" || u.type === "slash") && (O.output = w + O.output),
                                    C(O);
                                continue;
                            }
            ...
            var ir = K((ys, ar) => {
                ...
                var Fn = require("path"),
                    ...
                    P = (e, t, r = !1) => {
                        ...
                        let s = t || {},
                            a = Ye.isWindows(t),
                            i = n ? P.compileRe(e, t) : P.makeRe(e, t, !1, !0),
                            o = i.state;
                        delete i.state;
                        let h = () => !1;
                        if (s.ignore) {
                ...
                P.matchBase = (e, t, r, n = Ye.isWindows(r)) =>
                    (t instanceof RegExp ? t : P.makeRe(t, r)).test(Fn.basename(e));
                P.isMatch = (e, t, r) => P(t, r)(e);
                P.parse = (e, t) =>
                    Array.isArray(e) ? e.map(r => P.parse(r, t)) : Ze(e, F(I({}, t), { fastpaths: !1 }));
                P.scan = (e, t) => Qn(e, t);
                ...
                me = class extends ve.BaseCommand {
                    ...
                    async execute() {
                        ...
                        if (this.all) a = new Set(r.workspaces);
                            ...
                            a = new Set(this.workspaces.map(o => r.getWorkspaceByIdent(rt.structUtils.parseIdent(o))));
                        }
                        for (let o of a) {
                        ...
                        for (let o of r.workspaces) {
                            a.has(o) ? this.production && o.manifest.devDependencies.clear()
            ...
            var Ne = Q(require("@yarnpkg/cli")),
                ...
                Ee = class extends Ne.BaseCommand {
                    constructor() {
                        ...
                        this.parallel = G.Option.Boolean("-p,--parallel", !1, {
                    ...
                    async execute() {
                        ...
                        for (let g of f) {a && !g.manifest.scripts.has(a) && !p
                                || a === process.env.npm_lifecycle_event && g.cwd === n.cwd
                                || this.include.length > 0
                                    && !Be.default.isMatch(Z.structUtils.stringifyIdent(g.locator), this.include)
                                || this.exclude.length > 0
                                    && Be.default.isMatch(Z.structUtils.stringifyIdent(g.locator), this.exclude)
                        ...
                        let v = this.parallel
                            ...
                            k = null,
                            J = !1,
                            ie = await be.StreamReport.start(
                                ...
                                async g => {
                                        ...
                                        try {
                                            ...
                                            if (this.verbose) {
                                                let Y = t.get("enableTimers")
                                                    ? `, completed in ${
                                                        Z.formatUtils.pretty(t, B - c, Z.formatUtils.Type.DURATION)
                                                    }`
                                                    : "";
                                    ...
                                    for (; E.size > 0 && !g.hasErrors();) {
                                        ...
                                        for (let [x, T] of E) {
                                            ...
                                            if (this.topological || this.topologicalDev) {
                                                ...
                                                for (let c of u.values()) {
                                                    ...
                                                    if (
                                                        U = $ === null || !E.has($.anchoredLocator.locatorHash), !U
                                                    ) {
                                                        break;
                                                    }
                                                }
                                            ...
                                            if (
                                                !!U
                                                && (H.add(T.anchoredDescriptor.descriptorHash),
                                                    D.push(b(async () => {
                                                        let u = await w(T, { commandIndex: ++L });
                                                        return E.delete(x),
                                                            H.delete(T.anchoredDescriptor.descriptorHash),
                                                            u;
                                                    })),
                                                    !_)
                                            ) {
                                        ...
                                        if (D.length === 0) {
                                            let x = Array.from(E.values()).map(T =>
                                                Z.structUtils.prettyLocator(t, T.anchoredLocator)
                                            ).join(", ");
                                            g.reportError(
                                                be.MessageName.CYCLIC_DEPENDENCIES,
                                                `Dependency cycle detected (${x})`,
                                            );
                                            return;
                                        }
